...
const IndexPageComponent = () => {
  ...
  const {
    ...
    data: fetchPhaseData,
  } = useQuery(PhaseAPI.get);

  return (
    <Spinner visible={fetchPhaseLoading}>
                      ...
                      <div>
                        ...
                        <dl className="mt-6 flex flex-col sm:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
                          ...
                          <dd className="flex items-center text-sm text-gray-500 font-medium sm:mr-6">
                            ...
                            Nachádzate sa vo fáze č.{" "}
                            {fetchPhaseData?.phase.number}
                          </dd>
                          ...
                          <dd className="mt-3 flex items-center text-sm text-gray-500 font-medium sm:mt-0 sm:mr-6">
                            ...
                            {fetchPhaseData?.phase.startDate} -{" "}
                            {fetchPhaseData?.phase.endDate}
                          </dd>
                        </dl>
                      </div>
                    </div>
